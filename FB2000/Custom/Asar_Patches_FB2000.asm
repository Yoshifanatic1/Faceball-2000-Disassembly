; Note: Put your custom routine/data macros, references to them, and defines in this file from within the FB2000_InsertIntegratedPatches and FB2000_ApplyPatchesPostAssembly macros below.
; By doing this:
...
macro FB2000_InsertIntegratedPatches()
...
macro FB2000_ApplyPatchesPostAssembly()
