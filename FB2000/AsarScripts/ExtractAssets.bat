...
:Start
echo Place a headerless FB2000 ROM named %ROMName% in this folder, then type the number representing what version %ROMName% is.
echo 0 = FB2000 (USA)
...
echo You need to place a FB2000 ROM named %ROMName% in this folder before you can extract any assets^^!
goto :Mode
...
if %PointerSet% equ 12 goto :MoveTextures
if %PointerSet% equ 18 goto :MoveTilemaps
if %PointerSet% equ 24 goto :MovePalettes
